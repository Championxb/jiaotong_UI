...
const content = ref([
  {
    ...
    text: [
      "重庆西站为高架候车模式，站房设计采用上进下出为主、下进下出为辅的进出站方式，共设五层，采用“综合交通、立体布局”的方式。",
      "重庆西建筑设计",
      "重庆西整体布局",
      "重庆西设施情况",
      "重庆西站台线路",
  ...
  },
  {
    ...
    text: [
      "站场建设总规模 14 台 26 线，北端衔接沪汉蓉快速客运通道、西成高速铁路，南端衔接成渝高速铁路、成贵铁路，日均铁路客运量达到 9 万人次。",
      "成都东建筑设计",
      "成都东整体布局",
      "成都东设施情况",
      "成都东站台线路",
  ...
  },
  {
    ...
    text: [
      "成都西站是一个集铁路、公交、地铁、有轨电车为一体的综合性区域交通枢纽。站房建筑面积 7020.38 ㎡，含结合有轨电车蓉 2 号线改扩建 1020 ㎡。",
      "成都西建筑设计",
      "成都西整体布局",
      "成都西设施情况",
      "成都西站台线路",
  ...
  },
  {
    ...
    text: [
      "杭州西站整体以“云之城”为设计理念，以“城市未来生活典范区”为目标，以“云端站房”为设计概念，提出“云谷”、“云路”、“云厅”意向。",
      "杭州西站建筑设计",
      "杭州西站整体布局",
      "杭州西站设施情况",
      "杭州西站站台线路",
  ...
  },
  {
    ...
    text: [
      "沙坪坝站TOD项目结合地铁埋深,构建了深度达到47米的地下八层空间,拆迁量达到14.1万平方米。其中,住宅1015户,非住宅（含商铺）117户。",
      "沙坪坝站建筑设计",
      "沙坪坝站整体布局",
      "沙坪坝站设施情况",
      "沙坪坝站站台线路",
  ...
  },
  {
    ...
    text: [
      "虹桥综合交通枢纽本体各交通主体的平面布局由东向西依次为：航站楼、东交通中心、磁浮、高铁、西交通中心。",
      "上海虹桥建筑设计",
      "上海虹桥整体布局",
      "上海虹桥设施情况",
      "上海虹桥站台线路",
